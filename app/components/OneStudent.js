            ...
            <tbody>
              <tr>
                ...
                <td>
                  ...
                  {/* <div className="dropdown" onSelect={function(evt){console.log(evt)}}>
                    ...
                    {campuses.map(campus => {
                      if (singleStudent && campus.name !== singleStudent.campus.name) {
                        return  <button className="dropdown-item" type="button" key={campus.id} value={campus.id}>{campus.name}</button>
                      }
                    })}
                    </div>
                  </div> */}
